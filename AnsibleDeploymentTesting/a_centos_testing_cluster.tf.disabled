module "centos_testing_cluster" {
  ...
  network_type = [
    data.vsphere_virtual_machine.template_centos.network_interface_types[0]
  ]

  ### Data Disks section

  ### Disks section
  disk_label     = ["${var.name_prefix}-centos-disk0"]      ### disk0
  ...
  ###########################################
  vmname = "${var.name_prefix}-centos-"
  //  vmnamesuffix = ""
  //  vmnameliteral = ""
  ### required
  vmtemp     = data.vsphere_virtual_machine.template_centos.name
  instances  = "1"
  cpu_number = "2"
  ram_size   = "1024"
  ### required
