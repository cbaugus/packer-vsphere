...
provisioned_disks = [
  {
    device_drive = "sdb"
    label = "frank_nomad_staging_s3_label"
    disk_size = "large"
    thin_provisioned = "true"
    eagerly_scrub = "false"
    data_disk_scsi_controller = "0"
    LABEL_sdb = "frank_nomad_staging_s3_cache"
    S3_HOST_1 = "https://nonprods3fs01.dal.jhdc.local:9000"
    S3_MOUNT_1 = "/mnt/local/frank_nomad_staging_s3_mount"
    S3_UID_1 = "1000"
    S3_GID_1 = "1002"
    S3_ACL_1 = "private"
    S3_CACHE_1 = "/mnt/local/frank_nomad_staging_s3_cache"
...
nomad_host_volumes = [
  {
    "name" = "frank-nomad"
    "path" = "/mnt/local/frank_nomad_staging_s3_mount/default/files"
    "owner" = "cicduser"
    "group" = "nomad"
    "mode" = "0777"
    "read_only" = "false"
