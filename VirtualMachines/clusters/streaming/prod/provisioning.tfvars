...
s3_provisioned_disks = [
  {
    DEVICE_DRIVE = "sdb"
    LABEL = "wowza_content_s3_cache"
    S3_HOST_1 = "https://prod.truenasscale.dal.jhdc.local:9000/"
    ...
    S3_ACCESS_KEY_1 = "dal_prod_minio_s3_streaming_access_key"
    S3_SECRET_KEY_1 = "dal_prod_minio_s3_streaming_secret_key"
